...
void Menu::menu()
{
	...
	do
	{
		...
		std::cout << "1. Wyszukiwanie najkrotszej sciezki" << std::endl;
		std::cout << "2. Wyszukiwanie minimalnego drzewa rozpinajacego" << std::endl;
...
void Menu::menuShortestPath()
{
	...
	do
	{
		...
		std::cout << choices << ". Cofnij do wyboru problemu" << std::endl;
